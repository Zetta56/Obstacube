...
class Button(pygame.sprite.Sprite):
  ...
  def __init__(self, display, center, color, text, function, 
    ...
    self.text = Text(self.display, self.button_rect.center, font_size)
  ...
  def blit(self):
    self.display.fill(self.button_color, self.button_rect)
    self.text.blit()